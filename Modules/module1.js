...
app.controller("myWatches1Controller",function($scope,$window){
    ...
    $scope.item1 = function(){
        ...
        // $document.getElementById('img1').src= $scope.watches1[i].image;
        // $document.getElementById('price1').innerHTML= $scope.watches1[i].price;
        // $document.getElementById('Pb1').innerHTML= $scope.watches1[i].brand;
        // $document.getElementById('PR1').innerHTML=$scope.watches1[i].rating;
    }
    ...
    //         // {
    //             $window.alert(a);
    //             $document.getElementById('img1').src= watches1[a].image;
    //             $document.getElementById('price1').innerHTML= watches1[a].price;
    //             $document.getElementById('Pb1').innerHTML= watches1[a].brand;
    //             // document.getElementById('PD1').innerHTML=Laptops1[a].description;
    //             $document.getElementById('PR1').innerHTML=watches1[a].rating;
    //             // document.getElementById('PU1').innerHTML=Laptops1[a].url;
                
    //         // }
    //         // else{
    //             // document.getElementById('img1').src= Laptops1[0].image;
    //             // document.getElementById('price1').innerHTML="Both items are Same Items";
    //             // document.getElementById('Pb1').innerHTML="Cannot Compare";
    //         // }
...
app.controller("myWatches2Controller",function($scope,$window){
    $scope.imageAddress2 = "https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/No-Image-Placeholder.svg/1665px-No-Image-Placeholder.svg.png";
    $scope.price2 = "";
    $scope.pb2 = "";
    $scope.pr2 = "";
